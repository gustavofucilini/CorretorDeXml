...
import br.com.swconsultoria.nfe.Enviar;
import br.com.swconsultoria.nfe.Epec;
import br.com.swconsultoria.nfe.Eventos;
...
public class Nfe {
     ...
     * @throws NfeException
     */
    public static String consultaXmlRetornoString(ConfiguracoesNfe configuracoesNfe, String chave, DocumentoEnum tipoDocumento) throws NfeException {

        return ConsultaXml.consultaXmlRetornoString(ConfiguracoesUtil.iniciaConfiguracoes(configuracoesNfe), chave, tipoDocumento);

    }
    
    public static TRetConsSitNFe consultaXmlRetornoTRetConsSitNFe(ConfiguracoesNfe configuracoesNfe, String chave, DocumentoEnum tipoDocumento) throws NfeException {

        return ConsultaXml.consultaXmlRetornoTRetConsSitNFe(ConfiguracoesUtil.iniciaConfiguracoes(configuracoesNfe), chave, tipoDocumento);
