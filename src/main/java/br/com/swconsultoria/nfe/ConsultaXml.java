...
class ConsultaXml {
     ...
     * @throws NfeException
     */
    static String consultaXmlRetornoString(ConfiguracoesNfe config, String chave, DocumentoEnum tipoDocumento) throws NfeException {
    ...
    static TRetConsSitNFe consultaXmlRetornoTRetConsSitNFe(ConfiguracoesNfe config, String chave, DocumentoEnum tipoDocumento) throws NfeException {
